...
import br.com.generation.projetointegrador.repository.TemaRepository;
...
public class TemaController {
	...
	public ResponseEntity<List<Tema>> getByHashtag(@PathVariable String hashtag) {
		return ResponseEntity.ok(temaRepository.findAllByDescricaoContainingIgnoreCase(hashtag));
	}

	@GetMapping("/palavrachave/{palavrachave}")
	public ResponseEntity<List<Tema>> getBypalavrachave(@PathVariable String palavrachave) {
		return ResponseEntity.ok(temaRepository.findAllByDescricaoContainingIgnoreCase(palavrachave));
	}
